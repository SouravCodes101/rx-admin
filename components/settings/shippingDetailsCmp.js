                ...
                <Row>
                  <Col xs={14}>
                    ...
                    >
                      ...
                      <Form.Control name="prepayDiscount"  value={this.state.prepayDiscount} onChange={(e)=>{this.setState({prepayDiscount:e})}}/>
                    </Form.Group>
                  </Col>
                  <Col xs={8}>
                    <Form.Group
                    ...
                    >
                      ...
                      <Form.Control name="localShipping" value={this.state.localShipping} onChange={(e)=>{this.setState({localShipping:e})}}/>
                    </Form.Group>
                  </Col>
                </Row>
                <Row>
                  <Col xs={14}>
                    ...
                    >
                      ...
                      <Form.Control name="localShippingLimit" value={this.state.localShippingLimit} onChange={(e)=>{this.setState({localShippingLimit:e})}}/>
                    </Form.Group>
                  </Col>
                  <Col xs={9}>
                    <Form.Group controlId="prepayDiscountExemptionLimit" className={"margin-btn"}   >
                      ...
                      <Form.Control name="prepayDiscountExemptionLimit" value={this.state.prepayDiscountExemptionLimit} onChange={(e)=>{this.setState({prepayDiscountExemptionLimit:e})}}/>
                    </Form.Group>
                  </Col>
                </Row>
